...
let private string_tables = FsLexYaccLiteRuntime.LexTables(string_asciiAlphabetTable, string_nonAsciiCharRangeTable, string_nonAsciiAlphabetTable, string_transitionTable, string_acceptTable)
...
let private codestring_tables = FsLexYaccLiteRuntime.LexTables(codestring_asciiAlphabetTable, codestring_nonAsciiCharRangeTable, codestring_nonAsciiAlphabetTable, codestring_transitionTable, codestring_acceptTable)
