...
let outputParser (input : string) (output : string) (modname : string option) (lexlib : string) (parslib : string) (code : string) (spec : ParserSpec) (preprocessed : Preprocessed) (compiled : Compiled) =
